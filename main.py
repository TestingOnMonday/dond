...
import random # for randomizing the order of cases
...
# functions here
def scramble(list): # randomly scramble input
  random.shuffle(list)
  return list
def setup(): # sets up the vals list to use for the game
	order = scramble(CASES) # shuffles the case order to use when drawing the screen
